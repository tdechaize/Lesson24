# Lesson24
Lesson24 OpenGL (from NeHe)

Vous trouverez dans le sommaire ci-desous les explications vous permettant de reconstituer cette application illustrant plusieurs cas d'usage d'OpenGL :
Token, Extensions, Scissoring & TGA loading (en provenance du site NeHe).
...
Voici, un résumé succinct de la structure de cette application :

## OpenGL Tutorial #24.

Project Name: Jeff Molofee's OpenGL Tutorial

Project Description : Token, Extensions, Scissoring & TGA loading Tutorial
